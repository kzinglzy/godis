...
// SomeEntries samples the dictionary to return a few entries from random locations
func (dt *Dict) SomeEntries(count int64) []*Entry {
...
func (dt *Dict) RandomEntry() *Entry {
	if dt.Used() == 0 {
		return nil
	}
...
func (dt *Dict) maxSizeMask() int64 {
